    ...
    579: () => {
      ...
      document.getElementById("submit").addEventListener("click", function () {
        ...
        (document.getElementById("error").innerText = ""),
          ...
          axios
            .post("https://avivminiurl.herokuapp.com/:".concat(n, "/new"), "data", { headers: e })
            .then(function (e) {
              document.getElementById("url").value = e.data;
            })
            .catch(function (e) {
              e.response && (document.getElementById("error").innerText = e.response.data);
            });
      }),
        ...
        document.getElementById("register").addEventListener("click", function () {
          ...
          axios
            .post("https://avivminiurl.herokuapp.com:".concat(n, "/users/new"), "data", {
              headers: e,
            })
            .then(function (e) {
              var t = "welome "
                .concat(e.data.userName, ', your password is  "')
                .concat(e.data.password, '"');
              document.getElementById("registerStatus").innerText = t;
            })
            .catch(function (e) {
              e.response && (document.getElementById("registerStatus").innerText = e.response.data);
            });
        }),
        document.getElementById("login").addEventListener("click", function () {
          ...
          axios
            .put("https://avivminiurl.herokuapp.com:".concat(n, "/login"), "data", { headers: e })
            .then(function (e) {
              (localStorage.name = e.data.name),
                (localStorage.password = e.data.password),
                a(e.data.name, document.getElementById("password").value),
                o(localStorage.name);
            })
            .catch(function (e) {
              e.response && (document.getElementById("loginStatus").innerText = e.response.data);
            });
        }),
        document.getElementById("logout").addEventListener("click", function () {
          localStorage.clear(), location.reload();
        });
      var n = process.env.PORT || 1042;
      function o(e) {
        (document.getElementById("greetins").innerText = "welcome ".concat(e)),
      ...
      function a(t, o) {
        ...
        axios
          .put("https://avivminiurl.herokuapp.com:".concat(n, "/users/").concat(t), "data", {
            headers: a,
          })
          .then(function (t) {
      ...
      function r(t) {
        ...
        try {
          for (d.s(); !(n = d.n()).done; ) {
            var u = n.value;
            ("string" != typeof u && "number" != typeof u) || (u = document.createTextNode(u)),
              c.appendChild(u);
          }
        } catch (e) {
          d.e(e);
